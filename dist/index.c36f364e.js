...
typewriter.pauseFor(80).typeString("GDSC is a global program by Google that supports stoodent").pauseFor(100).deleteChars(8).typeString(" student developers in enhancing their technical and professional skills, forest").deleteChars(6).typeString("fostering innovation and creating impact through resources and community.").pauseFor(5000).start();
// hacker
//home
// {
